\def\CTeXPreproc{Created by ctex v0.2.11, don't edit!}%% BioMed_Central_Tex_Template_v1.06
%%                                      %
...
\documentclass[10pt]{ctextemp_bmc_article}
\usepackage{amsmath,amssymb}
\usepackage{latexsym}            % for the qed symbol
\usepackage{multirow}
\usepackage{graphicx}
\usepackage{epsfig}
\usepackage[ruled,vlined]{ctextemp_algorithm2e}
...
\input{ctextemp_Introduction.tex}
\input{ctextemp_Background.tex}
\input{ctextemp_Results.tex}
\input{ctextemp_Discussions.tex}
\input{ctextemp_Methods.tex}
\bigskip
...
\input{ctextemp_Tables.tex}
\clearpage
\input{ctextemp_Figures}

\input{ctextemp_Appendix.tex}
\clearpage
\input{ctextemp_AppendixB.tex}


\input{ctextemp_AppendixC.tex}
